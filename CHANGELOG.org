...
- New optional constant ~yet-gptel-backend~.
- New optional constant ~yet-gptel-model~.
- New optional constant ~yet-gptel-remove-citations~.
- New optional constant ~yet-gptel-default-directive~.
- New optional constant ~yet-display-time~.
...
- Set =htmlize-html-charset= to "utf-8".
- Set =htmlize-convert-nonascii-to-entities= to nil (do not encode Cyrillic).
